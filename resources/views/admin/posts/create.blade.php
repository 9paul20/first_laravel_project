        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Agrega Post</h4>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ $errors->has('title')? 'is-invalid' : '' }}" name="title" id="title" placeholder="Redacta tu titulo" value="{{ old('title') }}">
                        @if ($errors->any())
                ...
                <form method="POST" action="{{ route('admin.posts.store') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('excerpt')? 'is-invalid' : '' }}" name="excerpt" id="excerpt" placeholder="Redacta el extracto del post" value="{{ old('excerpt') }}">
                            @if ($errors->any())
                                <div class="invalid-feedback">
...
{{-- Redacta <em>el</em> <u>cuerpo</u> del <strong>post</strong> --}}{{--
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                <input type="text" name="published_at" id="published_at" class="form-control datetimepicker-input {{ $errors->has('published_at')? 'is-invalid' : '' }}" data-target="#reservationdate" value="{{ old('published_at') }}">
